...
const SellerProfile = () => {
  ...
  const [stats, setStats] = useState([
    { label: 'Total Orders', value: '0', color: 'text-orange-500' },
    { label: 'Email Verified', value: 'No', color: 'text-yellow-500' },
  ...
  const statsWithIcons = stats.map((stat, index) => {
    const icons = [Package, Mail, Star, Trophy];
    return {
      ...stat,
